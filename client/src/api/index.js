...
export const registerUser = (payload) => api.post(`/register/`, payload).catch((err) => {return err})
export const loginUser = (payload) => api.post(`/login/`, payload).catch((err) => {return err})
